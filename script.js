...
function submitForm(name, email, subject, message) {
    ...
    .catch(error => {
        ...
        // Even on error (due to CORS-less Apps Script) show success modal as UX fallback
        showSuccessModal('✨ Thank you! Your message has been received. If you don\'t hear back, please email me directly.');
